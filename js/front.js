...
function countup() {
    ...
    $countdownNumbers.days.text(days);
    $countdownNumbers.hours.text(hours);
    $countdownNumbers.minutes.text(mins);
    $countdownNumbers.seconds.text(secs);

    clearTimeout(date.to);
    date.to = setTimeout(function () {
        countup(date);
    }, 1000);
}
